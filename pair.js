...
const IMAGE_URL = 'https://files.catbox.moe/n2ol5k.jpg'; // Nouvelle image unique
      ...
      buttons: [
        {
          ...
          buttonText: { displayText: '🤖THUS MINIBOT 🤖' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
    ...
    break;
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *Thus ᴍɪɴɪ ʙᴏᴛ ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀɪɴɢ ᴄᴏᴅᴇ ɪs:* ${result.code}`
                        }, { quoted: msg });
...
`;
        ...
        await socket.sendMessage(sender, {
            ...
            contextInfo: {
                ...
                forwardedNewsletterMessageInfo: {
                    newsletterJid: '120363407561123100@newsletter',
                    newsletterName: 'THUS MINI WHATSAPP BOT',
                    serverMessageId: -1
                }
            }
        }, { quoted: fakevCard });
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 ᴛʜᴜs ᴍɪɴɪ ʙᴏᴛ ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
...
case 'shorturl': {
  try {
    ...
    await socket.sendMessage(sender, {
      ...
      forwardedNewsletterMessageInfo: {
        newsletterJid: '120363407561123100@newsletter',
        newsletterName: 'DELTA THUS WHATSAPP BOT',
        serverMessageId: -1
      }
    });
